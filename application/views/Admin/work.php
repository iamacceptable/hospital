	        		...
	        		<div class="content-wrapper">
			              ...
			              <div class="card">
			                <div class="card-body">
			                  ...
			                  <form class="forms-sample" method="POST" enctype="multipart/form-data" action="<?= base_url();?>index.php/Admin/update_work">
			                    ...
			                    <div class="form-group">
			                      ...
			                      <input type="file" name="wimg" class="file-upload-default">
			            ...
			            <div class="col-lg-12 grid-margin stretch-card">
			              <div class="card">
			                <div class="card-body">
			                  <h4 class="card-title">Current Works</h4>
			                  ...
			                  <div class="table-responsive">
			                    <table class="table table-hover">
			                      ...
			                      <tbody>
			                      	<?php $count=1; foreach($works as $slider):?>
				                        <tr>
				                          <td><?= $count++; ?></td>
				                          <td><a href="<?= $slider['link'];?>"><?= $slider['title'];?></a></td>
				                          <td><?= $slider['description'];?></td>
				                          <td><a href="<?= base_url();?>index.php/Admin/delete_work/<?= $slider['id'];?>" class="text-danger"><i class="ti-close"></i> Delete</a></td>
				                        </tr>
			                    	<?php 
			                    		endforeach;
			                    		if($count == 1){
			                    	?>
				                        <tr>
				                        	<td colspan="4" class="text-center">No Works Yet!!</td>
				                        </tr>
			                    	<?php } ?>
			                      </tbody>
			                    </table>
